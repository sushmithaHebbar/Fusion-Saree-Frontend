...
const UploadArea = ({ title, placeholder, image, setter, clear, openModalCroped, isCropped }) => {
  ...
  export const UploadView = ({ startGeneration, palluImage, setPalluImage, bodyImage, setBodyImage, borderImage, setBorderImage, isCropModalOpen, imageTypeToCrop, closeCropModal, openModalCroped, setCroppedPallu, setCroppedBody, setCroppedBorder, description, setDescription, croppedPallu, croppedBody, croppedBorder }) => {
